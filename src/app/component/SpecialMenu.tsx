...
export default function SpecialMenu() {
  return (
    <div className='p-10'>
      <h1 className='text-2xl border-red-500 font-bold mb-6 text-left '><b>Special Menu For You</b></h1>
      <div className='grid grid-cols-3 gap-8'> {/* Grid layout for 6 cards */}
        ...
        <div className=' p-4 rounded shadow-md flex flex-col items-center'>
          <Image
            ...
            className="rounded mb-2 size-auto"
          />
        ...
        <div className=' p-4 rounded shadow-md flex flex-col items-center'>
          <Image
            ...
            className="rounded mb-2 size-auto"
          />
          <h2 className='text-black font-bold text-left w-full font-serif pt-24'>Sendwich</h2>
